...
def end_screen(first, second, third, fourth):
	...
	while running:
		...
		if first > second and first > third and first > fourth:
			screen.blit(font.render(f"Winner is: Slaktar Sune", True, black), (screen_width/4, 50))
			...
			screen.blit(font.render(f"Winner is: Boxare Bob", True, black), (screen_width / 4, 50))
			...
			screen.blit(font.render(f"Winner is: Bråkiga Berit", True, black), (screen_width / 4, 50))
			screen.blit(player3_l, (710, 435))
			screen.blit(player1, (550, 500))
			screen.blit(player2, (500, 500))
			screen.blit(player4, (450, 500))
		elif fourth > first and fourth > third and fourth > second:
			screen.blit(font.render(f"Winner is: Hänsynslöse Hannes", True, black), (screen_width / 4, 50))
			screen.blit(player4_l, (710, 435))
			screen.blit(player1, (550, 500))
			screen.blit(player2, (500, 500))
			screen.blit(player3, (450, 500))
		elif first == second and first > third and first > fourth:
			screen.blit(font.render(f"It's a tie", True, black), (screen_width / 4, 50))
			screen.blit(player4, (550, 500))
